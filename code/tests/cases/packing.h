int16_t dummy_2bytes(librg_world *world, librg_event *event) {
    zpl_unused(world);
...
int16_t dummy_2bytes_reject(librg_world *world, librg_event *event) {
    zpl_unused(world);
...
int16_t dummy_size(librg_world *world, librg_event *event) {
    zpl_unused(world);
    zpl_unused(event);
...
MODULE(packing, {
    ...
    IT("should slip create section with rejection and ignore data", {
        librg_world *world = librg_world_create();
    ...
    IT("should skip update section with rejection and ignore data", {
        librg_world *world = librg_world_create();
    ...
    IT("should skip remove section with rejection and ignore data", {
        librg_world *world = librg_world_create();
